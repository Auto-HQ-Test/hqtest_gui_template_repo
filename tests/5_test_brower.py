...
@function_logging
async def check_brower_KR(settings, test_logger):
    pass

@function_logging
async def check_brower_EN(settings, test_logger):
    pass
...
async def test_browser(settings, test_logger):
    ...
    # 한국어 배너 확인
    await check_brower_KR(settings, test_logger)
    # 영어 배너 확인
    await check_brower_EN(settings, test_logger)
